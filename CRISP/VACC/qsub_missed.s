#!/bin/bash
#PBS -l nodes=1:eth10gb:ppn=8,pmem=8gb,pvmem=8gb
...
#PBS -o /users/m/k/mkellygo/CRISP/output1/10/${PBS_JOBNAME}_${PBS_JOBID}.out
...
time julia scripts/run_CRISP_Rdist_missed_jobs.jl ${PBS_ARRAYID} $PASSy 
wait
echo all processes complete
ti=$(date +"%H:%M:%S.%N")
echo "completed job $PASSx part $PASSy at $ti"
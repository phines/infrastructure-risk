...
costs = xlsread('..\VACC\results\experiments\strat_samp\int0\RiskResults_case39_n-1_gen-6-5.csv');
costs = costs(:,1)
%costs1 = xlsread('..\VACC\results\experiments\strat_samp\int0\RiskResults_case73_noPWS_lx2_n-1.csv');
costs1 = xlsread('..\VACC\results\experiments\strat_samp\ngi\RiskResults_case39_n-1_gen-6-5.csv');
costs1 = costs1(:,1);
costs2 = xlsread('..\VACC\results\experiments\strat_samp\nucp\RiskResults_case39_n-1_gen-6-5.csv');
costs2 = costs2(:,1);
costs3 = xlsread('..\VACC\results\experiments\strat_samp\comm\RiskResults_case39_n-1_gen-6-5.csv');
costs3 = costs3(:,1);
costs4 = xlsread('..\VACC\results\experiments\strat_samp\crt\RiskResults_case39_n-1_gen-6-5.csv');
costs4 = costs4(:,1)
...
costs = xlsread('..\VACC\results\experiments\strat_samp\int0\RiskResults_case39_n-1_gen-8-5.csv');
costs = costs(:,1)
%costs1 = xlsread('..\VACC\results\experiments\strat_samp\int0\RiskResults_case73_noPWS_lx2_n-1.csv');
costs1 = xlsread('..\VACC\results\experiments\strat_samp\ngi\RiskResults_case39_n-1_gen-8-5.csv');
costs1 = costs1(:,1);
costs2 = xlsread('..\VACC\results\experiments\strat_samp\nucp\RiskResults_case39_n-1_gen-8-5.csv');
costs2 = costs2(:,1);
costs3 = xlsread('..\VACC\results\experiments\strat_samp\comm\RiskResults_case39_n-1_gen-8-5.csv');
costs3 = costs3(:,1);
costs4 = xlsread('..\VACC\results\experiments\strat_samp\crt\RiskResults_case39_n-1_gen-8-5.csv');
costs4 = costs4(:,1)
...
costs = xlsread('..\VACC\results\experiments\strat_samp\int0\RiskResults_case39_n-1_gen-10-5.csv');
costs = costs(:,1)
%costs1 = xlsread('..\VACC\results\experiments\strat_samp\int0\RiskResults_case73_noPWS_lx2_n-1.csv');
costs1 = xlsread('..\VACC\results\experiments\strat_samp\ngi\RiskResults_case39_n-1_gen-10-5.csv');
costs1 = costs1(:,1);
costs2 = xlsread('..\VACC\results\experiments\strat_samp\nucp\RiskResults_case39_n-1_gen-10-5.csv');
costs2 = costs2(:,1);
costs3 = xlsread('..\VACC\results\experiments\strat_samp\comm\RiskResults_case39_n-1_gen-10-5.csv');
costs3 = costs3(:,1);
costs4 = xlsread('..\VACC\results\experiments\strat_samp\crt\RiskResults_case39_n-1_gen-10-5.csv');
costs4 = costs4(:,1)
...
% %% Ranking Interactions
% 
% costs = xlsread('..\VACC\results\experiments\strat_samp\int0\RiskResults_case39_n-1_gen-1-2.csv');
% costs = costs(:,1)
% %costs1 = xlsread('..\VACC\results\experiments\strat_samp\int0\RiskResults_case73_noPWS_lx2_n-1.csv');
% costs1 = xlsread('..\VACC\results\experiments\strat_samp\ngi\RiskResults_case39_n-1_gen-1-2.csv');
% costs1 = costs1(:,1);
% costs2 = xlsread('..\VACC\results\experiments\strat_samp\nucp\RiskResults_case39_n-1_gen-1-2.csv');
% costs2 = costs2(:,1);
% costs3 = xlsread('..\VACC\results\experiments\strat_samp\comm\RiskResults_case39_n-1_gen-1-2.csv');
% costs3 = costs3(:,1);
% costs4 = xlsread('..\VACC\results\experiments\strat_samp\crt\RiskResults_case39_n-1_gen-1-2.csv');
% costs4 = costs4(:,1)
% 
% costs(isnan(costs))=0;
% costs1(isnan(costs1))=0;

...
costs = xlsread('..\VACC\results\experiments\mh\casc2+crt\RiskResults_case73_noPWS_lx2_n-1.csv');
costs = costs(:,1)
...
legend("Compounding Risk Over Time","Natural Gas","Nuclear Poisson", "Communications")
xlabel("x")
